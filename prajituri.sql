...
CREATE TABLE IF NOT EXISTS prajituri (
   ...
   tip_produs tipuri_produse DEFAULT 'cofetarie',  --coloana: tip_produs, tipul de date al coloanei: tipuri_produse, default: valoarea pe care o ia by default
   ...
   imagine VARCHAR(300),   --daca avem de memorat fisiere, mai bine memoram calea catre ele
