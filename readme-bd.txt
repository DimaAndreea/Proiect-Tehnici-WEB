...
CREATE USER andreea03 WITH ENCRYPTED PASSWORD 'ParolaPa55';
GRANT ALL PRIVILEGES ON DATABASE cti_2024 TO andreea03 ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO andreea03;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO andreea03;


Cont google:
email: papetariapapirus@gmail.com
parola: Parola.ProiectPa55
parola bengoasa: ijtq iqbx mavw sjni
